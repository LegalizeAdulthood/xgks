...
void display_clr_mixer_area(void)
{
    ...
    left_extent[MAX].x = window[MIN].x + (window[MAX].x - window[MIN].x) / 4.0;
    left_extent[MIN].y = window[MIN].y + (window[MAX].y - window[MIN].y) / 4.0;
    left_extent[MAX].y = window[MAX].y - (window[MAX].y - window[MIN].y) / 4.0;

    right_extent[MIN].x = window[MAX].x - (window[MAX].x - window[MIN].x) / 4.0;
    ...
    mixer_arrow.con = window[MAX].y - (window[MAX].y - window[MIN].y) / 8.0;
    ...
    center.y = window[MIN].y + (window[MAX].y - window[MIN].y) / 8.0;
...
void display_fine_tuner_area(void)
{
    ...
    tuner_extent[MIN].x = window[MIN].x + (window[MAX].x - window[MIN].x) / 7.0;
    tuner_extent[MAX].x = window[MAX].x - (window[MAX].x - window[MIN].x) / 7.0;
    tuner_extent[MIN].y = window[MIN].y + (window[MAX].x - window[MIN].x) / 7.0;
    tuner_extent[MAX].y = window[MAX].y - (window[MAX].x - window[MIN].x) / 20.0;
    ...
    center.x = (tuner_extent[MIN].x + tuner_extent[MAX].x)
        / 2.0;
    center.y = tuner_extent[MAX].y + (window[MAX].y - tuner_extent[MAX].y) / 2.0;
    ln_ptr = lines;
    ...
    hue_arrow.con = tuner_extent[MIN].y - (tuner_extent[MIN].y - window[MIN].y) / 3.0;
    hue_arrow.knob_pos = NO_KNOB_DRAWN;

    display_arrow(TUNER_AREA, &hue_arrow, ((hsv_clr.hue / 360.0) * (hue_arrow.maxi - hue_arrow.mini) + hue_arrow.mini));
    center.y = window[MIN].y + (tuner_extent[MIN].y - window[MIN].y) / 4.0;
    ...
    val_arrow.con = tuner_extent[MIN].x - (tuner_extent[MIN].x - window[MIN].x) / 3.0;
    val_arrow.knob_pos = NO_KNOB_DRAWN;

    display_arrow(TUNER_AREA, &val_arrow, (hsv_clr.val * (val_arrow.maxi - val_arrow.mini) + val_arrow.mini));
    center.x = window[MIN].x + (tuner_extent[MIN].x - window[MIN].x) / 4.0;
    ...
    sat_arrow.con = tuner_extent[MAX].x + (window[MAX].x - tuner_extent[MAX].x) / 3.0;
    sat_arrow.knob_pos = NO_KNOB_DRAWN;

    display_arrow(TUNER_AREA, &sat_arrow, (hsv_clr.sat * (sat_arrow.maxi - sat_arrow.mini) + sat_arrow.mini));
    center.x = window[MAX].x - (window[MAX].x - tuner_extent[MAX].x) / 4.0;
