...
C***********************************************************************GKS00900
      ...
      INTEGER*4     I,J,IA(32),MENLEN(5),ICLASS,SGNA                    GKS00940
...
C*************************************************************          GKS02630
                                                                        GKS02640
      DO 60 I=0,4                                                       GKS02650
        STARTX = 0.065                                                  GKS02660
        STARTY = 0.590 - I * 0.130                                      GKS02670
        DO 30 J=1,4                                                     GKS02680
          PX(J) = SELBLK(J) + STARTX                                    GKS02690
          PY(J) = SELBLK(J+4) + STARTY                                  GKS02700
   30   CONTINUE                                                        GKS02710
                                                                        GKS02720
C*************************************************************          GKS02730
C*****                                                   *****          GKS02740
...
C*************************************************************          GKS02770
                                                                        GKS02780
        CALL GCRSG(I+1)                                                 GKS02790
        CALL GFA(4,PX,PY)                                               GKS02800
        WRITE(CH,'(I1)')I+1                                             GKS02810
        CALL GSTXAL(GACENT,GAHALF)                                      GKS02820
        CALL GTXS(STARTX+0.05,STARTY+0.05,1,CH)                         GKS02830
        CALL GSTXAL(GAHNOR,GAVNOR)                                      GKS02840
                                                                        GKS02850
C*************************************************************          GKS02860
C*****                                                   *****          GKS02870
...
C*************************************************************          GKS02910
                                                                        GKS02920
        IA(I+1) = GPRON                                                 GKS02930
        CALL GCLSG                                                      GKS02940
        CALL GSDTEC(I+1,1)                                              GKS02950
                                                                        GKS02960
C*************************************************************          GKS02970
C*****                                                   *****          GKS02980
...
C*************************************************************          GKS03020
                                                                        GKS03030
        STARTX = 0.190                                                  GKS03040
        STARTY = 0.606 - I * 0.130                                      GKS03050
        DO 40 J = 1,7                                                   GKS03060
          PX(J) = ARROW(J) + STARTX                                     GKS03070
          PY(J) = ARROW(J+7) + STARTY                                   GKS03080
   40   CONTINUE                                                        GKS03090
        CALL GPL(7,PX,PY)                                               GKS03100
        STARTX = 0.400                                                  GKS03110
        STARTY = 0.590 - I * 0.130                                      GKS03120
        DO 50 J=1,4                                                     GKS03130
          PX(J) = TXTBLK(J) + STARTX                                    GKS03140
          PY(J) = TXTBLK(J+4) + STARTY                                  GKS03150
   50   CONTINUE                                                        GKS03160
                                                                        GKS03170
C*************************************************************          GKS03180
C*****                                                   *****          GKS03190
...
C*************************************************************          GKS03270
                                                                        GKS03280
        CALL GFA(4,PX,PY)                                               GKS03290
        STARTX = STARTX + 0.015                                         GKS03300
        STARTY = STARTY + 0.020                                         GKS03310
        CALL GTXS(STARTX,STARTY,MENLEN(I+1),MENTXT(I+1))                GKS03320
   60 CONTINUE                                                          GKS03330
                                                                        GKS03340
C*************************************************************          GKS03350
C*****                                                   *****          GKS03360
...
C*************************************************************          GKS03420
     ...
     *           LDRCDU,DRCDUM)                                         GKS03480
      ...
      CALL GINCH(WKID,1,1,1,2,XMIN,XMAX,YMIN,YMAX,                      GKS03500
     *           LDRCDU,DRCDUM)                                         GKS03510
      CALL GSCHM(WKID,1,2,1)                                            GKS03520
      CALL GSPKM(WKID,1,2,1)                                            GKS03530
      CALL GMSGS(WKID,31,'    PICK SQUARES TO SELECT ITEM')             GKS03540
                                                                        GKS03550
C*************************************************************          GKS03560
C*****                                                   *****          GKS03570
...
C*************************************************************          GKS03610
                                                                        GKS03620
   70 CALL GWAIT(600.0,WKID,ICLASS,IDEV)                                GKS03630
      IF (ICLASS.EQ.4) THEN                                             GKS03640
        CALL GGTCH(STAT,SGNA)                                           GKS03650
      ELSE                                                              GKS03660
        IF (ICLASS.EQ.5) THEN                                           GKS03670
          CALL GGTPK(STAT,SGNA,PCID)                                    GKS03680
        ELSE                                                            GKS03690
          GOTO 70                                                       GKS03700
        ENDIF                                                           GKS03710
      ENDIF                                                             GKS03720
...
C*************************************************************          GKS04020
                                                                        GKS04030
      IF (SGNA.EQ.1) THEN                                               GKS04040
        CALL MAPDEM                                                     GKS04050
      ELSE                                                              GKS04060
        IF (SGNA.EQ.2) THEN                                             GKS04070
          CALL PRIMIT                                                   GKS04080
        ELSE                                                            GKS04090
          IF (SGNA.EQ.3) THEN                                           GKS04100
            CALL COLOR                                                  GKS04110
          ELSE                                                          GKS04120
            IF (SGNA.EQ.4) THEN                                         GKS04130
              CALL INTER                                                GKS04140
            ELSE                                                        GKS04150
              GOTO 90                                                   GKS04160
            ENDIF                                                       GKS04170
...
C***********************************************************************GKS05090
     ...
     *           ERRIND,LDRCOL,DTRCOL)                                  GKS05120
      CALL GINCH(WKID,1,1,1,3,XMIN,XMAX,YMIN,YMAX,LDRCOL,DTRCOL)        GKS05130
...
C***********************************************************************GKS05330
                                                                        GKS05340
      SUBROUTINE COLOR                                                  GKS05350
      INCLUDE 'gkspar.inc'                                              GKS05360
                                                                        GKS05370
      INTEGER*4    WKID,WTYPE,NUMELA,LCHSTR(5),LENGTH,ERRIND            GKS05380
      INTEGER*4    CRID,CGID,CBID,CHNR,I,STAT,SGNA,PCID,J,K             GKS05390
      INTEGER*4    TABLE(4,4)                                           GKS05400
                                                                        GKS05410
      REAL*4       CR,CG,CB,XMIN,XMAX,YMIN,YMAX,PX(10),PY(10)           GKS05420
      REAL*4       FRAME1(10),FRAME2(10),FRAME3(10),FRAME4(10)          GKS05430
      REAL*4       COLBOX(8),INTBOX(8),MIXBOX(8),ARROW(14)              GKS05440
      REAL*4       FFX(4),FFY(4),GREEN(16),BLUE(16)                     GKS05450
                                                                        GKS05460
      LOGICAL      NORED,NOGRN,NOBLU,INVPK,CONT                         GKS05470
                                                                        GKS05480
      CHARACTER*45 MENU                                                 GKS05490
      CHARACTER*2  INDEX(16)                                            GKS05500
      CHARACTER*1  COLORI(3)                                            GKS05510
      CHARACTER*80 DTREC(5)                                             GKS05520
                                                                        GKS05530
      COMMON       /WINF/   WKID,WTYPE                                  GKS05540
      COMMON       /TEXT/   TXTX,TXTY                                   GKS05550
      COMMON       /LIMITS/ XMIN,XMAX,YMIN,YMAX                         GKS05560
                                                                        GKS05570
      DATA MENU   /'DEFINE COLSET TABLERESET TABLSPECTRUMRETURN'/       GKS05580
      DATA LCHSTR /10,9,10,8,6/                                         GKS05590
      DATA NUMELA /5/                                                   GKS05600
      DATA FRAME1 /0.000,0.000,1.000,1.000,0.000,                       GKS05610
     *             0.000,1.000,1.000,0.000,0.000/                       GKS05620
                                                                        GKS05630
      DATA FRAME2 /0.015,0.015,0.985,0.985,0.015,                       GKS05640
     *             0.745,0.985,0.985,0.745,0.745/                       GKS05650
      DATA FRAME3 /0.015,0.015,0.985,0.985,0.015,                       GKS05660
     *             0.430,0.730,0.730,0.430,0.430/                       GKS05670
      DATA FRAME4 /0.015,0.015,0.985,0.985,0.015,                       GKS05680
     *             0.015,0.415,0.415,0.015,0.015/                       GKS05690
      DATA COLBOX /0.001,0.050,0.050,0.001,0.001,0.001,0.130,0.130/     GKS05700
      DATA INTBOX /0.001,0.100,0.100,0.001,0.001,0.001,0.060,0.060/     GKS05710
      DATA MIXBOX /0.860,0.960,0.960,0.860,0.060,0.060,0.290,0.290/     GKS05720
      DATA ARROW  /0.000,0.150,0.150,0.200,0.150,0.150,0.000,           GKS05730
     *             0.016,0.016,0.000,0.024,0.048,0.032,0.032/           GKS05740
      DATA COLORI /'R','G','B'/                                         GKS05750
      DATA INDEX  /' 1',' 2',' 3',' 4',' 5',' 6',' 7',' 8',             GKS05760
     *             ' 9','10','11','12','13','14','15','16'/             GKS05770
      DATA TABLE  /15,11,07,03,                                         GKS05780
     *             14,10,06,02,                                         GKS05790
     *             13,09,05,01,                                         GKS05800
     *             12,08,04,16/                                         GKS05810
      DATA GREEN  /0.33,0.66,1.00,0.00,0.33,0.66,1.00,0.00,             GKS05820
     *             0.33,0.66,1.00,0.00,0.33,0.66,1.00,0.00/             GKS05830
      DATA BLUE   /0.00,0.00,0.00,0.33,0.33,0.33,0.33,0.66,             GKS05840
     *             0.66,0.66,0.66,1.00,1.00,1.00,1.00,0.00/             GKS05850
                                                                        GKS05860
C***********************************************************************GKS05870
C*****                                                               ***GKS05880
C*****   Initialize the choice device and use pack data record to    ***GKS05890
C*****   display the prompts for the various choices:                ***GKS05900
C*****                                                               ***GKS05910
C*****     Choice 1: Define a Color                                  ***GKS05920
C*****            2: Place Color in Current Color Table              ***GKS05930
C*****            3: Reset the Color Table to the Original           ***GKS05940
C*****            4: Display the Color Spectrum                      ***GKS05950
C*****            5: Return                                          ***GKS05960
C*****                                                               ***GKS05970
C***********************************************************************GKS05980
                                                                        GKS05990
      CALL GPREC(0,0,0,0.0,NUMELA,LCHSTR,MENU,NUMELA,                   GKS06000
     *           ERRIND,LENGTH,DTREC)                                   GKS06010
      CALL GCLRWK(WKID,1)                                               GKS06020
  100 CALL GINCH(WKID,1,1,1,3,XMIN,XMAX,YMIN,YMAX,LENGTH,DTREC)         GKS06030
                                                                        GKS06040
C***********************************************************************GKS06050
C*****                                                               ***GKS06060
C*****   Draw the borders and text for the demo menu frame.          ***GKS06070
C*****                                                               ***GKS06080
C***********************************************************************GKS06090
                                                                        GKS06100
      CALL GCRSG(1099)
      CALL GSPLCI(GYELOW)                                               GKS06110
      CALL GPL(5,FRAME1(1),FRAME1(6))                                   GKS06120
      CALL GPL(5,FRAME2(1),FRAME2(6))                                   GKS06130
      CALL GSTXFP(GFONT2,GSTRKP)                                        GKS06140
      CALL GSCHSP(0.1)                                                  GKS06150
      CALL GSCHH(0.080)                                                 GKS06160
      CALL GSTXCI(GYELOW)                                               GKS06170
      CALL GSTXAL(GACENT,GAVNOR)                                        GKS06180
      CALL GTXS(0.5,0.885,5,'COLOR')                                    GKS06190
      CALL GTXS(0.5,0.765,10,'FACILITIES')                              GKS06200
      CALL GPL(5,FRAME3(1),FRAME3(6))                                   GKS06210
                                                                        GKS06220
C***********************************************************************GKS06230
C*****                                                               ***GKS06240
C*****   Draw the current color table, making each fill area that    ***GKS06250
C*****   represents an index into the table a segment that can be    ***GKS06260
C*****   selected via the locator later in the program.              ***GKS06270
C*****                                                               ***GKS06280
C***********************************************************************GKS06290
                                                                        GKS06300
      CALL GSCHH(0.080)                                                 GKS06310
      CALL GTXS(0.5,0.630,11,'COLOR TABLE')                             GKS06320
      CALL GSTXAL(GAHNOR,GAVNOR)                                        GKS06330
      CALL GSTXFP(GFONT1,GCHARP)                                        GKS06340
      CALL GSCHH(0.030)                                                 GKS06350
      CALL GSFAIS(GSOLID)                                               GKS06360
      STARTY = 0.480                                                    GKS06370
      CALL GCLSG
      DO 120 I=1,16                                                     GKS06380
        CALL GSFACI(I)                                                  GKS06390
        STARTX = I * 0.060 - 0.035                                      GKS06400
        DO  110 J=1,4                                                   GKS06410
          PX(J) = COLBOX(J) + STARTX                                    GKS06420
          PY(J) = COLBOX(J+4) + STARTY                                  GKS06430
  110   CONTINUE                                                        GKS06440
        CALL GCRSG(I)                                                   GKS06470
        CALL GTXS(PX(1)+0.005,PY(1)-0.040,2,INDEX(I))                   GKS06450
                                                                        GKS06460
        CALL GFA(4,PX,PY)                                               GKS06480
        CALL GCLSG                                                      GKS06490
        CALL GSDTEC(I,GDETEC)                                           GKS06500
  120 CONTINUE                                                          GKS06510
                                                                        GKS06520
C***********************************************************************GKS06530
C*****                                                               ***GKS06540
C*****   Draw the color selection area on the lower half of the      ***GKS06550
C*****   display. Place each color fill area in a segment so that    ***GKS06560
C*****   it too can be selected by the locator device later on in    ***GKS06570
C*****   the program.                                                ***GKS06580
C*****                                                               ***GKS06590
C***********************************************************************GKS06600
                                                                        GKS06610
      CALL GCRSG(1098)
      CALL GPL(5,FRAME4(1),FRAME4(6))                                   GKS06620
      CALL GTXS(0.140,0.310,4,'  0%')                                   GKS06630
      CALL GTXS(0.265,0.310,4,' 33%')                                   GKS06640
      CALL GTXS(0.390,0.310,4,' 66%')                                   GKS06650
      CALL GTXS(0.515,0.310,4,'100%')                                   GKS06660
      CALL GSTXFP(GFONT2,GCHARP)                                        GKS06670
      CALL GSCHH(0.040)                                                 GKS06680
      CALL GSLWSC(2.0)                                                  GKS06690
      CALL GCLSG
      DO 160 I=1,3                                                      GKS06700
        CALL GSTXCI(I)                                                  GKS06710
        CALL GSFACI(I)                                                  GKS06720
        CALL GSPLCI(I)                                                  GKS06730
        STARTY = 0.315 - I * 0.085                                      GKS06740
	CALL GCRSG(1098 - I)
        CALL GTXS(0.060,STARTY+0.010,1,COLORI(I))                       GKS06750
	CALL GCLSG
        DO 140 J=1,4                                                    GKS06760
          STARTX = J * 0.125 + 0.010                                    GKS06770
          DO 130 K=1,4                                                  GKS06780
            PX(K) = INTBOX(K) + STARTX                                  GKS06790
            PY(K) = INTBOX(K+4) + STARTY                                GKS06800
  130     CONTINUE                                                      GKS06810
          SGNA = I * 4 + J + 16                                         GKS06820
          CALL GCRSG(SGNA)                                              GKS06830
          CALL GFA(4,PX,PY)                                             GKS06840
          CALL GCLSG                                                    GKS06850
          CALL GSDTEC(SGNA,GDETEC)                                      GKS06860
  140   CONTINUE                                                        GKS06870
                                                                        GKS06880
C***********************************************************************GKS06890
C*****                                                               ***GKS06900
C*****   Calculate and draw the three arrows that point to the       ***GKS06910
C*****   fill area which will contain the resulting color once       ***GKS06920
C*****   one has been chosen.                                        ***GKS06930
C*****                                                               ***GKS06940
C***********************************************************************GKS06950
                                                                        GKS06960
        DO 150 J=1,7                                                    GKS06970
          PX(J) = ARROW(J) + 0.635                                      GKS06980
          PY(J) = ARROW(J+7) + STARTY + 0.006                           GKS06990
  150   CONTINUE                                                        GKS07000
	CALL GCRSG(1080-I)
        CALL GPL(7,PX,PY)                                               GKS07010
	CALL GCLSG
  160 CONTINUE                                                          GKS07020
                                                                        GKS07030
C***********************************************************************GKS07040
C*****                                                               ***GKS07050
C*****   To demonstrate how the table works, show the color          ***GKS07060
C*****   selection for 0.66 of Red, Green and Blue in the            ***GKS07070
C*****   resulting color box and make each of their chooseable       ***GKS07080
C*****   segments invisible. This completes the drawing of the       ***GKS07090
C*****   initial demo frame.                                         ***GKS07100
C*****                                                               ***GKS07110
C***********************************************************************GKS07120
                                                                        GKS07130
      CRID = 23                                                         GKS07140
      ...
      CG = 0.66                                                         GKS07180
      CB = 0.66                                                         GKS07190
      CALL GSVIS(CRID,GINVIS)                                           GKS07200
      CALL GSVIS(CGID,GINVIS)                                           GKS07210
      CALL GSVIS(CBID,GINVIS)                                           GKS07220
      CALL GSFACI(GGRAY)                                                GKS07230
      CALL GCRSG(1081)
      CALL GFA(4,MIXBOX(1),MIXBOX(5))                                   GKS07240
      CALL GCLSG
                                                                        GKS07250
C***********************************************************************GKS07260
C*****                                                               ***GKS07270
C*****   Call subroutine RCHOI to wait for a valid choice from       ***GKS07280
C*****   the choice device.                                          ***GKS07290
C*****                                                               ***GKS07300
C***********************************************************************GKS07310
                                                                        GKS07320
  170 CALL GMSGS(WKID,1,' ')                                            GKS07330
      CALL RCHOI(WKID,5,CHNR)                                           GKS07340
                                                                        GKS07350
C***********************************************************************GKS07360
C*****                                                               ***GKS07370
C*****   If the choice was to define a color, display a message      ***GKS07380
C*****   for the user to pick three color intensities.               ***GKS07390
C*****                                                               ***GKS07400
C***********************************************************************GKS07410
                                                                        GKS07420
      IF (CHNR.EQ.1) THEN                                               GKS07430
        CALL GMSG(WKID,'  PICK 3 COLOR INTENSITIES')                    GKS07440
        CALL GSVIS(CRID,GVISI)                                          GKS07450
        CALL GSVIS(CGID,GVISI)                                          GKS07460
        CALL GSVIS(CBID,GVISI)                                          GKS07470
        NORED = .TRUE.                                                  GKS07480
        NOGRN = .TRUE.                                                  GKS07490
        NOBLU = .TRUE.                                                  GKS07500
        INVPK = .FALSE.                                                 GKS07510
                                                                        GKS07520
C***********************************************************************GKS07530
C*****                                                               ***GKS07540
C*****   Wait for three valid choices from the pick device - one     ***GKS07550
C*****   must be an intensity for red, one for green and one for     ***GKS07560
C*****   blue. Save the intensities choosen in CR,CG,and CB.         ***GKS07570
C*****                                                               ***GKS07580
C***********************************************************************GKS07590
                                                                        GKS07600
        DO 190 I=1,3                                                    GKS07610
  180     CALL GRQPK(WKID,1,STAT,SGNA,PCID)                             GKS07620
          IF (STAT.EQ.1) THEN                                           GKS07630
            IF ((SGNA.GE.21).AND.(SGNA.LE.24)) THEN                     GKS07640
              IF (NORED) THEN                                           GKS07650
                CRID = SGNA                                             GKS07660
                CR = REAL(SGNA - 21) / 3.0                              GKS07670
                NORED = .FALSE.                                         GKS07680
              ELSE                                                      GKS07690
                INVPK = .TRUE.                                          GKS07700
              ENDIF                                                     GKS07710
            ELSE                                                        GKS07720
              IF ((SGNA.GE.25).AND.(SGNA.LE.28)) THEN                   GKS07730
                IF (NOGRN) THEN                                         GKS07740
                  CGID = SGNA                                           GKS07750
                  CG = REAL(SGNA - 25) / 3.0                            GKS07760
                  NOGRN = .FALSE.                                       GKS07770
                ELSE                                                    GKS07780
                  INVPK = .TRUE.                                        GKS07790
                ENDIF                                                   GKS07800
              ELSE                                                      GKS07810
                IF ((SGNA.GE.29).AND.(SGNA.LE.32)) THEN                 GKS07820
                  IF (NOBLU) THEN                                       GKS07830
                    CBID = SGNA                                         GKS07840
                    CB = REAL(SGNA - 29) / 3.0                          GKS07850
                    NOBLU = .FALSE.                                     GKS07860
                  ELSE                                                  GKS07870
                    INVPK = .TRUE.                                      GKS07880
                  ENDIF                                                 GKS07890
                ELSE                                                    GKS07900
...
C***********************************************************************GKS07990
C*****                                                               ***GKS08000
C*****   If a valid intensity was not picked, wait for more input    ***GKS08010
C*****   from the pick device. Otherwise, set the fill area segment  ***GKS08020
C*****   for the intensity chosen to invisible.                      ***GKS08030
C*****                                                               ***GKS08040
C***********************************************************************GKS08050
                                                                        GKS08060
          IF (INVPK) THEN                                               GKS08070
            INVPK = .FALSE.                                             GKS08080
            GOTO 180                                                    GKS08090
          ELSE                                                          GKS08100
            CALL GSVIS(SGNA,GINVIS)                                     GKS08110
          ENDIF                                                         GKS08120
  190   CONTINUE                                                        GKS08130
                                                                        GKS08140
C***********************************************************************GKS08150
C*****                                                               ***GKS08160
C*****   Set the color representation for index 14 and draw the      ***GKS08170
C*****   resulting color in both the resultant fill area (MIXBOX)    ***GKS08180
C*****   and in index 14 of the main color table displayed above.    ***GKS08190
C*****                                                               ***GKS08200
C***********************************************************************GKS08210
                                                                        GKS08220
        CALL GSCR(WKID,14,CR,CG,CB)                                     GKS08230
      ELSE                                                              GKS08240
                                                                        GKS08250
C***********************************************************************GKS08260
C*****                                                               ***GKS08270
C*****   If the choice was to assign the color to an index, allow    ***GKS08280
C*****   the user to pick one of the color squares in the color      ***GKS08290
C*****   table shown above.                                          ***GKS08300
C*****                                                               ***GKS08310
C***********************************************************************GKS08320
                                                                        GKS08330
        IF (CHNR.EQ.2) THEN                                             GKS08340
          CALL GMSGS(WKID,23,'  ASSIGN COLOR TO INDEX')                 GKS08350
  200     CALL GRQPK(WKID,1,STAT,SGNA,PCID)                             GKS08360
          IF (STAT.LE.1) THEN                                           GKS08370
                                                                        GKS08380
C***********************************************************************GKS08390
C*****                                                               ***GKS08400
C*****   If a valid color index was picked, set the user defined     ***GKS08410
C*****   color to that index. Draw the fill area with the new        ***GKS08420
C*****   color.                                                      ***GKS08430
C*****                                                               ***GKS08440
C***********************************************************************GKS08450
                                                                        GKS08460
            IF (SGNA.GE.1 .AND. SGNA.LE.16) THEN                        GKS08470
              CALL GSCR(WKID,SGNA,CR,CG,CB)                             GKS08480
            ENDIF                                                       GKS08490
          ELSE                                                          GKS08500
            GOTO 200                                                    GKS08510
          ENDIF                                                         GKS08520
...
C***********************************************************************GKS08550
C*****                                                               ***GKS08560
C*****   If the choice was to reset the color table, reset all the   ***GKS08570
C*****   current variables and call subroutine SETCOL to define the  ***GKS08580
C*****   color table in its initial state.                           ***GKS08590
C*****                                                               ***GKS08600
C***********************************************************************GKS08610
                                                                        GKS08620
          IF (CHNR.EQ.3) THEN                                           GKS08630
            CALL GMSGS(WKID,19,'  COLOR TABLE RESET')                   GKS08640
            CALL SETCOL(WKID)                                           GKS08650
            CALL GSVIS(CRID,GVISI)                                      GKS08660
            CALL GSVIS(CGID,GVISI)                                      GKS08670
            CALL GSVIS(CBID,GVISI)                                      GKS08680
            CRID = 23                                                   GKS08690
            CGID = 27                                                   GKS08700
            CBID = 31                                                   GKS08710
            CR = 0.66                                                   GKS08720
            CG = 0.66                                                   GKS08730
            CB = 0.66                                                   GKS08740
            CALL GSVIS(CRID,GINVIS)                                     GKS08750
            CALL GSVIS(CGID,GINVIS)                                     GKS08760
            CALL GSVIS(CBID,GINVIS)                                     GKS08770
          ELSE                                                          GKS08780
                                                                        GKS08790
C***********************************************************************GKS08800
C*****                                                               ***GKS08810
C*****   If the choice was to display the color spectrum, draw a     ***GKS08820
C*****   demo frame that depicts the various colors available with   ***GKS08830
C*****   various intensities.                                        ***GKS08840
C*****                                                               ***GKS08850
C***********************************************************************GKS08860
                                                                        GKS08870
            IF (CHNR.EQ.4) THEN                                         GKS08880
              CALL SETUPF(.TRUE.,.TRUE.)                                GKS08890
              CALL GSTXCI(GWHITE)                                       GKS08900
              CALL GTXS(TXTX,TXTY,5,'COLOR')                            GKS08910
              CALL FINSHF(.TRUE.)                                       GKS08920
              DO 210 I=1,15                                             GKS08930
                CALL GSCR(WKID,I,0.00,GREEN(I),BLUE(I))                 GKS08940
  210         CONTINUE                                                  GKS08950
              CALL GSTXFP(GFONT1,GSTRKP)                                GKS08960
              CALL GSTXCI(GWHITE)                                       GKS08970
              CALL GSCHH(0.040)                                         GKS08980
              CALL GTXS(0.200,0.650,9,'RED:   0%')                      GKS08990
              CALL GTXS(0.440,0.580,5,'BLUE:')                          GKS09000
              CALL GTXS(0.025,0.280,6,'GREEN:')                         GKS09010
              CALL GSCHH(0.020)                                         GKS09020
              CALL GTXS(0.300,0.520,23,' 100%   66%   33%    0%')       GKS09030
              CALL GTXS(0.200,0.440,4,'100%')                           GKS09040
              CALL GTXS(0.200,0.340,4,' 66%')                           GKS09050
              CALL GTXS(0.200,0.240,4,' 33%')                           GKS09060
              CALL GTXS(0.200,0.140,4,'  0%')                           GKS09070
              CALL GCA(0.300,0.100,0.700,0.500,4,4,1,1,4,4,TABLE)       GKS09080
              FFX(1) = 0.3                                              GKS09090
              FFY(1) = 0.4                                              GKS09100
              FFX(2) = 0.4                                              GKS09110
              FFY(2) = 0.4                                              GKS09120
              ...
              FFX(4) = 0.3                                              GKS09150
              FFY(4) = 0.5                                              GKS09160
              DO 230 I=1,4                                              GKS09170
                DO 220 J=1,4                                            GKS09180
                  CALL GSFACI(TABLE(J,I))                               GKS09190
                  CALL GFA(4,FFX,FFY)                                   GKS09200
                  FFX(1) = FFX(1) + 0.1                                 GKS09210
                  FFX(2) = FFX(2) + 0.1                                 GKS09220
                  FFX(3) = FFX(3) + 0.1                                 GKS09230
                  FFX(4) = FFX(4) + 0.1                                 GKS09240
  220           CONTINUE                                                GKS09250
                FFX(1) = 0.3                                            GKS09260
                FFY(1) = FFY(1) - 0.1                                   GKS09270
                FFX(2) = 0.4                                            GKS09280
                FFY(2) = FFY(2) - 0.1                                   GKS09290
                FFX(3) = 0.4                                            GKS09300
                FFY(3) = FFY(3) - 0.1                                   GKS09310
                FFX(4) = 0.3                                            GKS09320
                FFY(4) = FFY(4) - 0.1                                   GKS09330
  230         CONTINUE                                                  GKS09340
                                                                        GKS09350
C***********************************************************************GKS09360
C*****                                                               ***GKS09370
C*****   Call RMENU to use pack data record to indicate two prompts  ***GKS09380
C*****   for the lpfks (next and return). RMENU will call RCHOI      ***GKS09390
C*****   to wait for a valid choice selection and will pass that     ***GKS09400
C*****   selection back in CHNR.                                     ***GKS09410
C*****                                                               ***GKS09420
C***********************************************************************GKS09430
                                                                        GKS09440
              CALL RMENU(.FALSE.,CONT)                                  GKS09450
                                                                        GKS09460
C***********************************************************************GKS09470
C*****                                                               ***GKS09480
C*****   If user chose to continue viewing the color spectrum,       ***GKS09490
C*****   continue on. Otherwise, fall out the bottom and return      ***GKS09500
C*****   to the color facilities main screen.                        ***GKS09510
C*****                                                               ***GKS09520
C***********************************************************************GKS09530
                                                                        GKS09540
              IF (CONT) THEN                                            GKS09550
                CALL GSCHH(0.040)                                       GKS09560
                CALL GSTXCI(GBLACK)                                     GKS09570
                CALL GTXS(0.200,0.650,9,'RED:   0%')                    GKS09580
                CALL GSTXCI(GWHITE)                                     GKS09590
                CALL GTXS(0.200,0.650,9,'RED:  33%')                    GKS09600
                DO 240 I=1,15                                           GKS09610
                  CALL GSCR(WKID,I,0.33,GREEN(I),BLUE(I))               GKS09620
  240           CONTINUE                                                GKS09630
                                                                        GKS09640
C***********************************************************************GKS09650
C*****                                                               ***GKS09660
C*****   Call RMENU to use pack data record to indicate two prompts  ***GKS09670
C*****   for the lpfks (next and return). RMENU will call RCHOI      ***GKS09680
C*****   to wait for a valid choice selection and will pass that     ***GKS09690
C*****   selection back in CHNR.                                     ***GKS09700
C*****                                                               ***GKS09710
C***********************************************************************GKS09720
                                                                        GKS09730
                CALL RMENU(.FALSE.,CONT)                                GKS09740
                                                                        GKS09750
C***********************************************************************GKS09760
C*****                                                               ***GKS09770
C*****   If user chose to continue viewing the color spectrum,       ***GKS09780
C*****   continue on. Otherwise, fall out the bottom and return      ***GKS09790
C*****   to the color facilities main screen.                        ***GKS09800
C*****                                                               ***GKS09810
C***********************************************************************GKS09820
                                                                        GKS09830
                IF (CONT) THEN                                          GKS09840
                  CALL GSTXCI(GBLACK)                                   GKS09850
                  CALL GTXS(0.200,0.650,9,'RED:  33%')                  GKS09860
                  CALL GSTXCI(GWHITE)                                   GKS09870
                  CALL GTXS(0.200,0.650,9,'RED:  66%')                  GKS09880
                  DO 250 I=1,15                                         GKS09890
                    CALL GSCR(WKID,I,0.66,GREEN(I),BLUE(I))             GKS09900
  250             CONTINUE                                              GKS09910
                                                                        GKS09920
C***********************************************************************GKS09930
C*****                                                               ***GKS09940
C*****   Call RMENU to use pack data record to indicate two prompts  ***GKS09950
C*****   for the lpfks (next and return). RMENU will call RCHOI      ***GKS09960
C*****   to wait for a valid choice selection and will pass that     ***GKS09970
C*****   selection back in CHNR.                                     ***GKS09980
C*****                                                               ***GKS09990
C***********************************************************************GKS10000
                                                                        GKS10010
                  CALL RMENU(.FALSE.,CONT)                              GKS10020
                                                                        GKS10030
C***********************************************************************GKS10040
C*****                                                               ***GKS10050
C*****   If user chose to continue viewing the color spectrum,       ***GKS10060
C*****   continue on. Otherwise, fall out the bottom and return      ***GKS10070
C*****   to the color facilities main screen.                        ***GKS10080
C*****                                                               ***GKS10090
C***********************************************************************GKS10100
                                                                        GKS10110
                  IF (CONT) THEN                                        GKS10120
                    CALL GSTXCI(GBLACK)                                 GKS10130
                    CALL GTXS(0.200,0.650,9,'RED:  66%')                GKS10140
                    CALL GSTXCI(GWHITE)                                 GKS10150
                    CALL GTXS(0.200,0.650,9,'RED: 100%')                GKS10160
                    DO 260 I=1,15                                       GKS10170
                      CALL GSCR(WKID,I,1.00,GREEN(I),BLUE(I))           GKS10180
  260               CONTINUE                                            GKS10190
                                                                        GKS10200
C***********************************************************************GKS10210
C*****                                                               ***GKS10220
C*****   Call RMENU to use pack data record to indicate to prompt    ***GKS10230
C*****   for the lpfk (return). RMENU will call RCHOI to wait for    ***GKS10240
C*****   a valid choice selection and will pass that selection back  ***GKS10250
C*****   in CHNR. But in this case, the user could only select       ***GKS10260
C*****   return as a valid choice, so we will fall down to the       ***GKS10270
C*****   return statement and go back to the color facilities main   ***GKS10280
C*****   panel.                                                      ***GKS10290
C*****                                                               ***GKS10300
C***********************************************************************GKS10310
                                                                        GKS10320
                    CALL RMENU(.TRUE.,CONT)                             GKS10330
                  ENDIF                                                 GKS10340
                ENDIF                                                   GKS10350
              ENDIF                                                     GKS10360
                                                                        GKS10370
C***********************************************************************GKS10380
C*****                                                               ***GKS10390
C*****   Reinitialize the color table and return to the color        ***GKS10400
C*****   facilities selection panel.                                 ***GKS10410
C*****                                                               ***GKS10420
C***********************************************************************GKS10430
                                                                        GKS10440
              CALL GCLRWK(WKID,GALWAY)                                  GKS10450
              CALL SETCOL                                               GKS10460
              GOTO 100                                                  GKS10470
            ELSE                                                        GKS10480
                                                                        GKS10490
C***********************************************************************GKS10500
C*****                                                               ***GKS10510
C*****   If the user selected return from the main panel, reset the  ***GKS10520
C*****   color table to its original state and return to the         ***GKS10530
C*****   selection frame of the main program.                        ***GKS10540
C*****                                                               ***GKS10550
C***********************************************************************GKS10560
                                                                        GKS10570
              IF (CHNR.EQ.5) THEN                                       GKS10580
                CALL SETCOL                                             GKS10590
                GOTO 270                                                GKS10600
              ENDIF                                                     GKS10610
            ENDIF                                                       GKS10620
          ENDIF                                                         GKS10630
...
C***********************************************************************GKS18060
      ...
      INCLUDE 'gkspar.inc'                                              GKS18090
                                                                        GKS18100
      INTEGER*4   WKID,WTYPE,I                                          GKS18110
      INTEGER*4   PIXEL1(9,9),PIXEL2(9,9)                               GKS18120
     ...
     *               8, 8,12,12,12,12,12, 8, 8/                         GKS18250
      DATA  PIXEL2 / 3,11,11,11,11,11,11,11, 3,                         GKS18260
     *               3, 3,11,11,11,11,11, 3, 3,                         GKS18270
     *               3, 3,11,11, 3,11,11, 3, 3,                         GKS18280
     *               3, 3,11,11, 3,11,11, 3, 3,                         GKS18290
     *               3, 3,11,11, 3,11,11, 3, 3,                         GKS18300
     *               3,11,11,11,11,11,11,11, 3,                         GKS18310
     *              11,11,11,11,11,11,11,11,11,                         GKS18320
     *              11,11,11,11,11,11,11,11,11,                         GKS18330
     *              11, 3,11, 3,11, 3,11, 3,11/                         GKS18340
                                                                        GKS18350
C***********************************************************************GKS18360
C*****                                                               ***GKS18370
...
C***********************************************************************GKS18530
                                                                        GKS18540
      CALL GCA(0.300,0.100,0.700,0.700,9,9,1,1,9,9,PIXEL2)              GKS18550
                                                                        GKS18560
C***********************************************************************GKS18570
C*****                                                               ***GKS18580
...
C***********************************************************************GKS18640
                                                                        GKS18650
      CALL RMENU(.FALSE.,CONT)                                          GKS18660
                                                                        GKS18670
C***********************************************************************GKS18680
C*****                                                               ***GKS18690
...
C***********************************************************************GKS18940
        ...
        DO 700 I=1,4                                                    GKS18970
          ...
          CALL GCA(X1,Y1,X2,Y2,9,9,1,1,9,9,PIXEL1)                      GKS19010
...
C***********************************************************************GKS19110
                                                                        GKS19120
        CALL RMENU(.FALSE.,CONT)                                        GKS19130
                                                                        GKS19140
C***********************************************************************GKS19150
C*****                                                               ***GKS19160
...
C***********************************************************************GKS19410
                                                                        GKS19420
          CALL GCA(0.100,0.615,0.650,0.815,9,9,1,1,9,9,PIXEL1)          GKS19430
          CALL GCA(0.100,0.100,0.650,0.565,9,9,1,1,9,9,PIXEL1)          GKS19440
          CALL GCA(0.700,0.100,0.900,0.815,9,9,1,1,9,9,PIXEL1)          GKS19450
                                                                        GKS19460
C***********************************************************************GKS19470
C*****                                                               ***GKS19480
...
C***********************************************************************GKS20520
                                                                        GKS20530
      CALL RMENU(.FALSE.,CONT)                                          GKS20540
                                                                        GKS20550
C***********************************************************************GKS20560
C*****                                                               ***GKS20570
...
C***********************************************************************GKS21130
                                                                        GKS21140
        CALL RMENU(.FALSE.,CONT)                                        GKS21150
                                                                        GKS21160
C***********************************************************************GKS21170
C*****                                                               ***GKS21180
...
C***********************************************************************GKS21430
	  ...
	  CALL GCRSG(5)
          CALL GTXS(0.550,0.825,8,'ROTATION')                           GKS21610
          CALL GTXS(0.050,0.825,7,'ZOOMING')                            GKS21640
	  CALL GCLSG
          CALL RMENU(.FALSE.,CONT)                                      GKS21780
...
C***********************************************************************GKS24800
                                                                        GKS24810
      CALL RMENU(.FALSE.,CONT)                                          GKS24820
                                                                        GKS24830
C***********************************************************************GKS24840
C*****                                                               ***GKS24850
...
C***********************************************************************GKS25460
                                                                        GKS25470
        CALL RMENU(.FALSE.,CONT)                                        GKS25480
                                                                        GKS25490
C***********************************************************************GKS25500
C*****                                                               ***GKS25510
...
C***********************************************************************GKS26280
                                                                        GKS26290
          CALL RMENU(.FALSE.,CONT)                                      GKS26300
                                                                        GKS26310
C***********************************************************************GKS26320
C*****                                                               ***GKS26330
...
C***********************************************************************GKS28640
                                                                        GKS28650
      CALL RMENU(.FALSE.,CONT)                                          GKS28660
                                                                        GKS28670
C***********************************************************************GKS28680
C*****                                                               ***GKS28690
...
C***********************************************************************GKS28970
        ...
        DO 1100 I=1,3                                                   GKS29060
          ...
          CALL GCLSG                                                    GKS29100
          CALL RMENU(.FALSE.,CONT)                                      GKS29110
...
C***********************************************************************GKS29750
                                                                        GKS29760
          CALL RMENU(.FALSE.,CONT)                                      GKS29770
                                                                        GKS29780
C***********************************************************************GKS29790
C*****                                                               ***GKS29800
...
C***********************************************************************GKS30510
                                                                        GKS30520
            CALL RMENU(.FALSE.,CONT)                                    GKS30530
                                                                        GKS30540
C***********************************************************************GKS30550
C*****                                                               ***GKS30560
...
C***********************************************************************GKS31050
                                                                        GKS31060
              CALL RMENU(.FALSE.,CONT)                                  GKS31070
                                                                        GKS31080
C***********************************************************************GKS31090
C*****                                                               ***GKS31100
...
C***********************************************************************GKS31590
                                                                        GKS31600
                CALL RMENU(.FALSE.,CONT)                                GKS31610
                                                                        GKS31620
C***********************************************************************GKS31630
C*****                                                               ***GKS31640
...
C***********************************************************************GKS32560
                                                                        GKS32570
                  CALL RMENU(.FALSE.,CONT)                              GKS32580
                                                                        GKS32590
C***********************************************************************GKS32600
C*****                                                               ***GKS32610
...
C******************************************************************     GKS44930
      ...
      CALL RCHOI(WKID,7,CHNR)                                           GKS44980
