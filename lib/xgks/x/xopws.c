...
Gint xXgksOpenWs(WS_STATE_PTR wk)
{
    ...
    wk->event_mask = StructureNotifyMask | EnterWindowMask | ExposureMask | LeaveWindowMask
        | KeyPressMask
        | ButtonPressMask | ButtonReleaseMask | ButtonMotionMask
        | FocusChangeMask;

#define DeviceEventsMask (KeyPressMask | KeyReleaseMask | ButtonPressMask | ButtonReleaseMask | PointerMotionMask | Button1MotionMask | Button2MotionMask | Button3MotionMask | Button4MotionMask | Button5MotionMask | ButtonMotionMask)
